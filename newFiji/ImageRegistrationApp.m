...
% -----------------SUBFUNCTIONS-------------------------------------
	...
	function changeTformType(varargin)
		if strcmp(get(gcbo,'type'),'uicontrol')
			cbstring = get(gcbo,'tag');
		elseif strcmp(get(gcbo,'type'),'uibuttongroup')
			cbstring = get(get(gcbo,'SelectedObject'),'tag');
		end
		
		if strcmp(cbstring,'Monomodal')
			set(MultimodalOptsPanel,'visible','off')
			set(MonomodalOptsPanel,'visible','on')
			[optimizer, metric] = imregconfig('Monomodal');
		elseif strcmp(cbstring,'Multimodal')

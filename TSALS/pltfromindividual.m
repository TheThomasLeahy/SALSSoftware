...
for i=1:51
    if i < 10
        filename = strcat('/','BT_0',num2str(i),'trans_18.txt_TSALS.txt');
    else
        filename = strcat('/','BT_',num2str(i),'trans_18.txt_TSALS.txt');
    end
...
clearvars filename delimiter startRow formatSpec fileID dataArray ans;
                ...
                fprintf(f,strcat('ZONE I= ',num2str(xdist),' J= ',num2str(ydist),' K=',num2str(slices),', DATAPACKING=POINT \n');
